      ...
      <div className="bg-base-100 card mx-6 mt-5 md:pt-4 px-6">
        <div className="content-center grid grid-cols-1 gap-4 p-4">
          <div className="flex justify-between items-center shadow-lg p-4 rounded-lg">
            <div>
              ...
              <div className="text-sm text-gray-500">
                This function will Send an embed message in the ticket channel.
              </div>
            </div>
          ...
          <div className="flex justify-between items-center shadow-lg p-4 rounded-lg">
            <div>
              <div className="text-base">
                Send All Registered Vouches to the Vouches Channel
              </div>
              <div className="text-sm text-gray-500">
                This function fetches all vouches from the database and sends
                them to the Vouches channel.
              </div>
            </div>
